...
### 21.5.5 OpenDeepWiki 与 DeepWiki-Open
...
### 21.5.6 CodeWiki、RepoAgent 与 Zread
...
## 21.6 持久知识编译型 LLM Wiki

这是最符合狭义 LLM Wiki 定义的一类。

### 21.6.1 nashsu/llm_wiki
...
### 21.7.4 Microsoft 365 Copilot + SharePoint
...
### 21.7.5 GitBook AI 与 GitBook Agent
...
### 21.15.1 从 RAG 转向 Knowledge Compilation
...
### 21.15.7 Wiki 将成为多 Agent 的共享长期状态层
...
> **使用提示**：与其他附录的分工——1 讲模型机制、2 讲方法论、3 记来源、4 列产品、5 辨异同、6 索引图版、7 详解 OTel、8 上手 DeepEval、9 评测观测平台选型、10 上手 Mem0、11 详解记忆晋升机制、12 盘点 Coding Agent 赛道、13 盘点可观测赛道、14 盘点评估赛道、15 盘点 Memory 赛道、16 盘点自进化赛道、17 盘点多 Agent 赛道、18 盘点 MCP 生态、19 盘点沙箱赛道、20 盘点 RAG 赛道、**21 盘点 LLM Wiki 赛道**、22 盘点 Loop Engineering 赛道、23 解析 Pi 源码、24 解析 Claude Code 源码、25 解析 Codex 源码、26 解析 OpenCode 源码。对照阅读：Wiki/RAG/知识图谱之辨（21.3）对第 11 章与附录 5.1/E.5、代码仓库型 Wiki（21.5）对第 23 章 Repo Map 与项目知识文件（DeepWiki 类即其托管放大版）、知识编译机制（21.11）对第 11 章 2.2 入库管线与附录 20、面向 Agent 的接口（21.12）对第 8 章 MCP 与第 11 章"检索即工具"、企业搜索（21.7）对第 21 章存量集成、失败模式（21.14）对附录 20 失败归因。信息基准 2026-08-31（[C-47]），发行前按附录 3 清单复核。
