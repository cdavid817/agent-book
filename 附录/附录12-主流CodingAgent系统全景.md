# 附录 12：主流 Coding Agent 系统全景

> 定位：**Coding Agent 赛道的全景调研报告·增强版**（全文收录，信息基准 2026-08-30，各产品官方入口见 [C-36]）。附录 4 是全品类产品速览与"坐标系定位法"，本附录只深潜 Coding Agent 一个赛道——商业/开源/国内/云端异步/多 Agent 工厂/审查 Agent/应用构建平台七类盘点，能力九维度，加上增强版六个专题：与通用平台 Agent 的关系与区别、代码理解（仓库认知建立）、LSP/AST/Symbol Index/Repo Map 详解、代码检索与上下文工程、沙箱与执行隔离、权限审批与安全治理，收尾于互操作标准（MCP/ACP/AGENTS.md）、评测体系与选型建议。第六篇（第 23–25 章）讲这一赛道的机制原理（技术专题与第 23 章 2.5/2.6 两节互为印证），附录 23/24/25 是其中三个系统的源码级解剖，本附录是"市场与技术专题"这一层的地图。名单与格局会过期，四层分类与九维度框架不过期。
...
## 12.5 主流开源 CodingAgent 与 Agent Harness
...
## 12.11 决定 CodingAgent 能力的九个核心维度

### 12.11.1 Context Engine
...
### 12.11.3 Agent-Computer Interface
...
## 12.12 CodingAgent 与通用平台 Agent 的关系和区别
...
### 12.12.2 CodingAgent 与通用平台 Agent 对比
...
### 12.12.3 CodingAgent 与 Code Interpreter 的区别
...
### 12.12.4 CodingAgent 与 Computer-Use Agent 的区别
...
## 12.13 代码理解：CodingAgent 如何建立仓库认知
...
## 12.14 LSP、AST、Symbol Index 与 Repo Map 详解
...
### 12.17.1 权限系统应控制“能力”，而不是只匹配命令字符串
...
## 12.19 CodingAgent 评测体系

### 12.19.1 主流 Benchmark
...
## 12.20 2026 年 CodingAgent 的关键趋势

### 12.20.1 IDE 正在变成 Agent 控制台
...
### 12.20.3 Worktree、Container 和 VM 成为基础设施
...
### 12.20.6 从 Prompt-Driven 转向 Spec-Driven
...
### 12.20.8 软件开发正在出现“生产 Agent + 验证 Agent”双层结构
...
## 12.22 统一多 CodingAgent 平台的通用架构参考
...
### 12.22.7 Artifact 与 Review Layer
...
> **使用提示**：与其他附录的分工——1 讲模型机制、2 讲方法论、3 记来源、4 列产品、5 辨异同、6 索引图版、7 详解 OTel、8 上手 DeepEval、9 评测观测平台选型、10 上手 Mem0、11 详解记忆晋升机制、**12 盘点 Coding Agent 赛道**、13 盘点可观测赛道、14 盘点评估赛道、15 盘点 Memory 赛道、16 盘点自进化赛道、17 盘点多 Agent 赛道、18 盘点 MCP 生态、19 盘点沙箱赛道、20 盘点 RAG 赛道、21 盘点 LLM Wiki 赛道、22 盘点 Loop Engineering 赛道、23 解析 Pi 源码、24 解析 Claude Code 源码、25 解析 Codex 源码、26 解析 OpenCode 源码。与附录 4 的分工：4 管全品类速览与定位法，本附录管 Coding Agent 单赛道深潜；重叠产品以各自官方页面为准（[C-36]）。对照阅读：标准系统架构（12.3）对第 12 章六大件、能力九维度（12.11）对第六篇三章、平台 Agent 对比（12.12）与代码理解/LSP/检索/沙箱/权限六专题（12.13–12.17）对第 23 章 2.1/2.5/2.6 与第 9/13 章、互操作标准（12.18）对第 8/18 章、评测体系（12.19）对第 15/24 章。信息基准 2026-08-30，发行前按附录 3 清单复核。
