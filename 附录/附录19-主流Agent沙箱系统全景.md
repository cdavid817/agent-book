...
## 19.5 Coding Agent 的沙箱方案

### 19.5.1 Docker Sandboxes
...
### 19.5.5 GitHub Copilot Coding Agent
...
## 19.7 Kubernetes 与自建沙箱控制平面

### 19.7.1 Kubernetes SIG Agent Sandbox
...
## 19.13 Coding Agent 中的 LSP、AST 和索引应该放在哪里
...
> **使用提示**：与其他附录的分工——1 讲模型机制、2 讲方法论、3 记来源、4 列产品、5 辨异同、6 索引图版、7 详解 OTel、8 上手 DeepEval、9 评测观测平台选型、10 上手 Mem0、11 详解记忆晋升机制、12 盘点 Coding Agent 赛道、13 盘点可观测赛道、14 盘点评估赛道、15 盘点 Memory 赛道、16 盘点自进化赛道、17 盘点多 Agent 赛道、18 盘点 MCP 生态、**19 盘点沙箱赛道**、20 盘点 RAG 赛道、21 盘点 LLM Wiki 赛道、22 盘点 Loop Engineering 赛道、23 解析 Pi 源码、24 解析 Claude Code 源码、25 解析 Codex 源码、26 解析 OpenCode 源码。对照阅读：什么是 Agent 沙箱与分层（19.1–19.2）对第 9 章三层沙箱、Coding Agent 沙箱对照（19.5）对第 23 章 2.6 产品表与附录 23/24/25 源码、底层隔离比较（19.8）对第 9 章机制、MCP 与沙箱（19.10）对第 8 章与附录 18、多 Agent 沙箱模式（19.12）对第 17/19 章、安全威胁矩阵与凭证（19.14–19.15）对第 13 章与第 21 章凭证三形态、可观测指标（19.16）对第 14 章与附录 13。信息基准 2026-08-30（[C-44]），发行前按附录 3 清单复核。
