...
| C-39 | 附录 P 全景盘点的 Memory 系统名单与能力状态（信息基准 2026-08，发行前逐项复核） | 各 Memory 系统官方页面与论文（Mem0/Zep/Letta 等） | 2026-08-30 |
| C-40 | 附录 Q 全景盘点的自进化系统与论文名单（信息基准 2026-08-30；**研究为主、非大规模商业部署**，发行前逐项复核） | 各研究团队论文与开源仓库 | 2026-08-30 |
...
- 附录 P：C-39（Memory 系统官方页面与论文）
- 附录 Q：C-40（自进化系统与论文，研究为主）
