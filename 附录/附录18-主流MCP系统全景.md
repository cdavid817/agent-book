...
## 18.7 Registry、Catalog 与 Marketplace

### 18.7.1 官方 MCP Registry
...
### 18.7.3 Docker MCP Catalog 与 Toolkit
...
### 18.8.1 AWS Bedrock AgentCore Gateway
...
### 18.8.2 Azure API Management 与 API Center
...
### 18.10.1 Prompt Injection 与 Tool Output Injection
...
> **使用提示**：与其他附录的分工——1 讲模型机制、2 讲方法论、3 记来源、4 列产品、5 辨异同、6 索引图版、7 详解 OTel、8 上手 DeepEval、9 评测观测平台选型、10 上手 Mem0、11 详解记忆晋升机制、12 盘点 Coding Agent 赛道、13 盘点可观测赛道、14 盘点评估赛道、15 盘点 Memory 赛道、16 盘点自进化赛道、17 盘点多 Agent 赛道、**18 盘点 MCP 生态**、19 盘点沙箱赛道、20 盘点 RAG 赛道、21 盘点 LLM Wiki 赛道、22 盘点 Loop Engineering 赛道、23 解析 Pi 源码、24 解析 Claude Code 源码、25 解析 Codex 源码、26 解析 OpenCode 源码。对照阅读：MCP 是什么与协议变化（18.2–18.3）对第 8 章与 [C-03] 版本 pin、Host 盘点（18.4）对附录 4 与 J、安全风险与基线（18.10–18.11）对第 8 章 2.4 描述投毒与第 13 章、工具膨胀治理（18.12）对第 5/7 章（上下文税与动态工具集）、Gateway（18.8）对第 21 章网关治理、协议关系（18.9）对第 18 章 A2A、可观测（18.15）对第 14 章与附录 13。信息基准 2026-08-30（[C-42]），发行前按附录 3 清单复核。
