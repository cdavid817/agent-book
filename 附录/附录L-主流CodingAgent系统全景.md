...
> 定位：**Coding Agent 赛道的全景调研报告·增强版**（全文收录，信息基准 2026-08-30，各产品官方入口见 [C-36]）。附录 D 是全品类产品速览与"坐标系定位法"，本附录只深潜 Coding Agent 一个赛道——商业/开源/国内/云端异步/多 Agent 工厂/审查 Agent/应用构建平台七类盘点，能力九维度，加上增强版六个专题：与通用平台 Agent 的关系与区别、代码理解（仓库认知建立）、LSP/AST/Symbol Index/Repo Map 详解、代码检索与上下文工程、沙箱与执行隔离、权限审批与安全治理，收尾于互操作标准（MCP/ACP/AGENTS.md）、评测体系与选型建议。第六篇（第 23–25 章）讲这一赛道的机制原理（技术专题与第 23 章 2.5/2.6 两节互为印证），附录 W/X/Y 是其中三个系统的源码级解剖，本附录是"市场与技术专题"这一层的地图。名单与格局会过期，四层分类与九维度框架不过期。
...
## L.5 主流开源 CodingAgent 与 Agent Harness
...
## L.11 决定 CodingAgent 能力的九个核心维度

### L.11.1 Context Engine
...
### L.11.3 Agent-Computer Interface
...
## L.12 CodingAgent 与通用平台 Agent 的关系和区别
...
### L.12.2 CodingAgent 与通用平台 Agent 对比
...
### L.12.3 CodingAgent 与 Code Interpreter 的区别
...
### L.12.4 CodingAgent 与 Computer-Use Agent 的区别
...
## L.13 代码理解：CodingAgent 如何建立仓库认知
...
## L.14 LSP、AST、Symbol Index 与 Repo Map 详解
...
## L.20 2026 年 CodingAgent 的关键趋势

### L.20.1 IDE 正在变成 Agent 控制台
...
### L.20.3 Worktree、Container 和 VM 成为基础设施
...
### L.20.6 从 Prompt-Driven 转向 Spec-Driven
...
### L.20.8 软件开发正在出现“生产 Agent + 验证 Agent”双层结构
...
## L.22 统一多 CodingAgent 平台的通用架构参考
...
### L.22.7 Artifact 与 Review Layer
