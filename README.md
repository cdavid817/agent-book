...
| [附录 Q：主流 Agent 自进化系统全景](附录/附录Q-主流Agent自进化系统全景.md) | Agent 自进化赛道全景调研（全文收录，信息基准 2026-08-30）——定义与易混概念、六路进化版图（经验/记忆/技能/工作流/模型自博弈/代码递归）、群体进化、评测体系、风险清单、生产参考架构与落地路线；第 26 章讲克制判断、Q 是赛道地图（研究为主，成熟度分层标注） |
