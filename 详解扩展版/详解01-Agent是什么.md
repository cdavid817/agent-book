...
> **定位**：本章是《企业级 Agent 从入门到专家（2026 版）》的认知地图，也是后续 27 章的统一坐标系。  
> **信息基准**：2026-08-31。  
> **扩展原则**：在原章“演进阶梯、三类历史教训、五要素、Agent 与 Workflow 边界、生产考量”的基础上，补齐形式化模型、自主性分级、运行时架构、工具与记忆边界、安全治理、评测指标、工程决策树和面试题。[21](#ref-21)
